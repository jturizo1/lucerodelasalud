<?php $title='Usuario'; require_once __DIR__ . '/../auth/check_auth.php'; if(is_admin()) redirect('../admin/users.php'); ?>
...
?>
<form id="userForm" class="needs-validation" novalidate method="post" action="/user/user_save.php" enctype="multipart/form-data">
